...
# --- Setup Page ---
st.set_page_config(page_title="🔮 Oracle V7.9.2", layout="centered") # Updated version to V7.9.2
...
# --- Header ---
st.markdown('<div class="big-title">🔮 ORACLE V7.9.2</div>', unsafe_allow_html=True) # Updated version to V7.9.2
