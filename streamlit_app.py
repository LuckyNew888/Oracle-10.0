...
# --- Setup Page ---
st.set_page_config(page_title="🔮 Oracle V6.9", layout="centered") # Updated version to V6.9
...
# --- Header ---
st.markdown('<div class="big-title">🔮 ORACLE V6.9</div>', unsafe_allow_html=True) # Updated version in title
