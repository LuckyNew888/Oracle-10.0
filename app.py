...
import random
# Import everything from oracle_engine.py
from oracle_engine import (
    MIN_HISTORY_FOR_PREDICTION, MAX_HISTORY_DISPLAY, MAX_HISTORY_FOR_ANALYSIS,
...
# Pass st.session_state.history to predict_outcome function
